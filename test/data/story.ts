export default {
  value: {
    ...
    content: {
      subtitle:
        'If you’re anything like us, you struggle to find a few, focused moments to get the important things done. With those precious, focused…',
      bodyModel: {
        paragraphs: [
          {
            name: '0032',
          ...
          },
          {
            ...
            type: 1,
            text:
              'If you’re anything like us, you struggle to find a few, focused moments to get the important things done. With those precious, focused minutes, it’s critical to spend them on the most important things, the things that are at the heart of your business.',
            markups: []
          },
          {
            name: 'c669',
            type: 1,
            text:
              'These things are different for every business, but for us, they look something like this:',
            markups: []
          },
          {
            name: '408b',
          ...
          },
          {
            ...
            type: 1,
            text:
              'And the things, which are important, but aren’t particularly interesting for us, look something like this:',
            markups: []
          },
          {
            name: 'bfd6',
          ...
          },
          {
            ...
            type: 1,
            text:
              'In a perfect world, we could delay or avoid doing those things in favor of the more meaningful and interesting tasks. Unfortunately, those things can’t be avoided forever, so we should do our best to spend the least amount of time possible on them.',
            markups: []
          },
          {
            name: 'e09c',
          ...
          },
          {
            ...
            type: 1,
            text:
              'There are some things you simply can’t avoid doing or pay someone else to do, especially when you’re just getting started. The best thing to do is to get them done as quickly and efficiently as possible.',
            markups: []
          },
          {
            name: '56a4',
            type: 1,
            text:
              'Here are some tactics we use to keep this stuff from draining us of our precious time and energy.',
            markups: []
          },
          {
            name: 'ba8e',
          ...
          },
          {
            ...
            type: 1,
            text:
              'Don’t spend too long doing this, but do it. You’ll start to realize which things are truly the most important and which things are just time-wasters.',
            markups: []
          },
          {
            name: '8609',
          ...
          },
          {
            ...
            type: 1,
            text:
              'Set a timer and try to get it done before it goes off. You’ll find motivation in trying to beat the time. It can be daunting but if you tell yourself “I can do this thing for 30 minutes”, you may find that it’s completely doable.',
            markups: []
          },
          {
            name: 'd324',
          ...
          },
          {
            ...
            type: 1,
            text:
              'Your business probably started from a place of deep passion for you. Don’t let it become a list of mundane and tedious tasks. Avoid spending time on the stuff you don’t care about, as much as possible.',
            markups: []
          }
        ],
        sections: []
      ...
      bodyModel: {
        paragraphs: [
          ...
          },
          {
            ...
            type: 1,
            text:
              'If you’re anything like us, you struggle to find a few, focused moments to get the important things done. With those precious, focused minutes, it’s critical to spend them on the most important things, the things that are at the heart of…',
            markups: [],
            alignment: 1
          }
        ],
    ...
    canonicalUrl:
      'https://medium.com/mortar-labs/avoid-spending-time-on-the-stuff-you-dont-care-about-34cac4656761',
  ...
  references: {
    User: {
      '3113c75d84a7': {
        ...
        username: 'franklin_4369',
        createdAt: 1538837405956,
        imageId: '1*WLhpp9H_WrvoirxhjNI7BQ.png',
        backgroundImageId: '',
        bio: 'https://mortar-labs.com/about'
      }
    }
  },
  expectedMarkdown: `

# Avoid Spending Time on the Stuff You Don’t Care About

![](https://cdn-images-1.medium.com/fit/200/258/1*bHYpuGdhx1EaRCFRIfXCqQ.png)
...
* Designing and coding (producing actual products for our clients)

* Strategizing about new channels or ways to improve our process

 And the things, which are important, but aren’t particularly interesting for us, look something like this:

* Company housekeeping tasks like bank account setup, updating Terms of Use, etc.

* Getting business cards, t-shirts, and other marketing material
